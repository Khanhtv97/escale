...
enum SerialPortName
{
   SPN_COM1 = 0, //Configure PIO11[0,1] - used for Scale (New hardware for Barcode Reader)
   SPN_COM2 = 1, //Configure PIO02[6,7] - used for Barcode Reader (New hardware for Scale)
